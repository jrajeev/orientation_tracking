function [q_fin, R_ukf]=ukf_4state_1(accel,gyro,P,Q,R)
    ...
    for i=1:size(accel,2)
        ...
        qi=quatmultiply(X',q_del');
        qi=quatnormalize(qi);
        Y=qi';
        
        % Gradient descent for a priori mean computation
        q=transpose(vect2quat(xcap));
        iters=0;
        norm_e=1;
