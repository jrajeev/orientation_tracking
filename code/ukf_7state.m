function [q_fin, R_ukf]=ukf_7state(accel,gyro,P,Q,R)
    ...
    for i=1:size(accel,2)
        ...
        tmp=K*v;
        xcap(1:4)=transpose(quatmultiply(transpose(xcap_(1:4)),transpose(vect2quat(tmp(1:3))))); % a posteriori estimate update
